...
class Tela1(QDialog):
    ...
    def __init__(self):
        ...
        label = QLabel("Quantos times?")
        self.line_edit = QLineEdit()
        botaoC = QPushButton("Continuar")
        botaoF = QPushButton("Fechar")
        ...
        self.setWindowTitle("Campeonato")
...
class Tela2(QDialog):
    ...
    Times=['Time 0','Time 1','Time 2','Time 3','Time 4','Time 5','Time 6', 'Time 7']
    Turno=1
    ...
    def __init__(self):
        ...
        label7= QLabel("Time 7: ")
        label6= QLabel("Time 6: ")
        label5= QLabel("Time 5: ")
        label4= QLabel("Time 4: ")
        label3= QLabel("Time 3: ")
        label2= QLabel("Time 2: ")
        label1= QLabel("Time 1: ")
...
class Tela3(QDialog):
    ...
    def __init__(self):
        ...
        temp=QLabel()
        self.layout.addWidget(temp)
        self.botaoT = QPushButton("+ 1 Turno")

        self.botaoT.setEnabled(False)
        self.layout.addWidget(self.botaoT)
        temp=QLabel()
        self.layout.addWidget(temp)
        self.botaoF = QPushButton("Encerrar")
        ...
        self.setWindowTitle("Tabela Jogos")
